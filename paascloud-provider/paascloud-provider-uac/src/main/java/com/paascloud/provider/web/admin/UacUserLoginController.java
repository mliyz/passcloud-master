...
import com.passcloud.common.base.dto.UserTokenDto;
...
public class UacUserLoginController extends BaseController {
	...
	public Wrapper<UacUser> login(@RequestBody LoginReqDto uacUser){
		logger.info("用户登陆.username={},password={}",uacUser.getLoginName(),uacUser.getLoginPwd());
		uacLoginService.login(uacUser);
